...
$$
D.h. diese Gleichung ist eine  *notwendige Bedingung* dafür, dass $u_{0}$ eine lokale Extremstelle von $\mathcal{F}$ ist.
(Etwas unpräzise formuliert gilt also an einer lokalen Extremstelle $\delta \mathcal{F}(u_{0},\xi)=0\forall \xi$).)
